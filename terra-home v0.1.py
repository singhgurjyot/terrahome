...
while listen:
    ...
    if intent == '"light"':
        ...
        if 'songname' in intent_resp['entities']:
            song_name = intent_resp['entities']['songname'][0]['value']
        else:
            song_name = ''
        if 'songartist' in intent_resp['entities']:
            song_artist = intent_resp['entities']['songartist'][0]['value']
        else:
            song_artist = ''
        if 'songmovie' in intent_resp['entities']:
            song_movie = intent_resp['entities']['songmovie'][0]['value']
        else:
            song_movie = ''
        ...
        if 'datetime' in intent_resp['entities']:
            date_ = intent_resp['entities']['datetime'][0]['value']
            date_ = date_[:10]
        else:
            date_ = None
